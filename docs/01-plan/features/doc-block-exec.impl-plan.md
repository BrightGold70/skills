...
> Source: docs/02-design/features/doc-block-exec.design.md (post-audit, v1.92 — design cycle 82 back-propagation, commit 93a13f4)
> Paired spec: docs/01-plan/features/doc-block-exec.spec.md (v1.53) · paired plan: docs/01-plan/features/doc-block-exec.plan.md (v1.84)
>
