...
| `h-mad/tests/mutation-specs/doc_block_exec.json` | mutation spec | FR-1..FR-5 — 33 mutations plus the AC-5.3 self-check, each with its `test` binding, enumerated in the design's Test Plan |
