...
gives 28 and is the error the design names at `docs/02-design/features/doc-block-exec.design.md:689`
— omitting the base costs callers the umbrella `except dbe.DocBlockError`), so callers
