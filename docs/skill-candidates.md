...
|---|---|---|
| 3 | `post-edit identifier sweep` | *yes* — **OPEN.** Re-grep a removed/renamed identifier across ALL surfaces after the LAST edit (code · comments · docs · tests · mutation-spec anchors); failed 1 of 3 tries by hand on 2026-08-24 and shipped 3 stale refs in `a311385` |
