...
The design is internally consistent with the paired plan and covers the requested scanner, substitution, execution, cleanup, stream, CLI, and wiring behavior. Axis C reconciliation finds every acceptance criterion implemented as written; no unannounced narrowing or omission was identified.
