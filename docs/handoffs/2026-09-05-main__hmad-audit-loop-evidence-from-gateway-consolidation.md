...
- **A fix round introduces the class it hunts.** The pre-c99 delta self-review fixed 3 defects; its three authors introduced 4 musts, all bare present-tense counts (`unanchored -S returns two`, `ls-tree 14 before and after`) moved by the commit publishing them. ≥17 of 98 cycles are fix-introduced (seeded lower bound); 63 origin-tagged lines exist from c98 on: author-self-caught 11, instrument 14, fix-introduced 13, propagation-gap 5, record-stale 5.
